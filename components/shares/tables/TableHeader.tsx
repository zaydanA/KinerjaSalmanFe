      ...
      <tr>
        {headers.map((h, index) =>
          index == 0 ? (
            ...
            <th
              key={index}
              className=" -border-b--clr-table-border sticky top-0 z-[1] whitespace-nowrap border-b-1 border-solid bg-clr-blackground-table-header p-4 px-3.5 text-start max-lg:text-sm max-md:text-xs max-sm:text-[10px]"
            >
              {h}
            </th>
          ),
